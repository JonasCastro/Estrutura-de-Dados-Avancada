 ...
 *  @author Kevin Wayne
 */
public final class BinaryStdIn3 {
	static TextFile in = getT(); 
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        while (!BinaryStdIn3.isEmpty()) {
            char c = BinaryStdIn3.readChar();
